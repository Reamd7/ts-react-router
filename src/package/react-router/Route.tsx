...
import matchPath , { Imatch } from "./matchPath";
 ...
 */
export class $Route<
  T extends I$RouteProps = I$RouteProps
> extends React.Component<T, any> {
  ...
  public computeMatch(
    props: I$RouteProps,
    router: IRouteContext["data"]["router"]
  ) {
  ...
  public render() {
    ...
    if (render){
      return match ? render({ match, location, history, staticContext }) : null;
    }

    if (typeof children === "function"){
      return match
        ? children({ match, location, history, staticContext })
        : null;
    }
